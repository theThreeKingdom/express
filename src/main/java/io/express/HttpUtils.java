...
public class HttpUtils {
    ...
    /**
     * Get long-type parameter. If parameter is not exist, or cannot be
     * converted to long, default value is return.
     *
     * @param name         Parameter name.
    ...
    /**
     * Get parameter value as String. If parameter is not exist, return default
     * value.
     *
     * @param name         Parameter name.
    ...
    public static void removeCookie(String name) {
        Cookie[] cookies = ActionContext.getActionContext().getHttpServletRequest().getCookies();
        for (Cookie cookie : cookies) {
