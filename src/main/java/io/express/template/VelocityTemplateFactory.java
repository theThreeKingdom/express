...
public class VelocityTemplateFactory extends TemplateFactory
{
	...
	public Template loadTemplate(String path) throws Exception
	{
		...
		return new VelocityTemplate(rtInstance.getTemplate(path, inputEncoding), null, outputEncoding);
	}
	...
	public void init(Config config)
	{
		...
		try
		{
			...
			else
			{
				...
				log.info("To using web application context path, remove property \"" + RuntimeConstants.FILE_RESOURCE_LOADER_PATH
